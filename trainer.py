...
class KoGPT2Chat(LightningModule):
    ...
    def train_dataloader(self):
        data = pd.read_csv('./dataset/wellness_dialog_total_dataset.csv', encoding='cp949')
...
if __name__ == "__main__":
    if args.train:
        checkpoint_callback = ModelCheckpoint(
            ...
            monitor='train_loss',
            mode='min',
            prefix='model_' # -> version 1.2.10 이후 삭제됨!
        )
...
#        model.kogpt2.save_pretrained('./finetuned_model/')
        ...
        trained_model=model.kogpt2.train(checkpoint_callback.best_model_path)
